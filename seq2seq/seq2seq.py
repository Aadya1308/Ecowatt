...
from tensorflow.keras.layers import Dense, Dropout, LSTM, Activation, RepeatVector, LSTMCell
...
df = pd.read_csv('kaggle_data_1h.csv', sep=',', low_memory=False, index_col='time', encoding='utf-8')
...
encoder_predict_model = keras.models.Model(encoder_inputs, list(encoder_states))
